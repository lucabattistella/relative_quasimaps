...
\ecd
Hence by the 4--lemma, the second vertical map is surjective if the first is. But this morphism is induced by the exact triangle
...
because $E$ is concentrated in degrees $[-1,0]$. So $\h^1(E_{\ev})=0$ as claimed. It is then straightforward to show that the morphism $E_{\ev} \to L_{\ev}$ satisfies the required properties.
