...
\begin{lemma} $k_{\text{v}}^! [ \mathcal{K}(\PP^N,A,i_*B)] = \virt{\mathcal{K}(X,A,B)}$ \end{lemma}
...
\ecd
The morphism $\theta$ does not have a perfect relative obstruction theory. Nevertheless, we can define a virtual pull-back morphism as follows.

\begin{definition} Suppose that we have a cartesian diagram
\bcd
...
Returning to our diagram above, there is a natural class on $\mathcal{L}(\PP^N|H)$ so we have a well-defined virtual pull-back $\theta_{\text{v}}^!$, and by the very definition:
...
\bcd
\mathcal{K}(X|Y) \ar[r] \ar[d] \ar[rd,phantom,"\square"] & \mathcal{K}(\PP^N|H) \ar[r] \ar[d] \ar[rd,phantom,"\square"] & \mathcal{L}(\PP^N|H) \ar[d,"\zeta"] \\
\mathcal{K}(X) \ar[r] \ar[d] \ar[rd,phantom,"\square"] & \mathcal{K}(\PP^N) \ar[r] \ar[d] & \mathcal{L}(\PP^N) \\
\om{Q}(X) \ar[r,"k"] & \om{Q}(\PP^N)
\ecd
Then we have
\begin{align*} k_{\text{v}}^! [ \mathcal{K}(\PP^N|H) ] & = k_{\text{v}}^! \zeta_{\text{v}}^! [ \mathcal{K}(\PP^N) ] \\
& = \zeta_{\text{v}}^! k_{\text{v}}^! [ \mathcal{K}(\PP^N) ] \\
& = \zeta_{\text{v}}^! \virt{\mathcal{K}(X)}
\end{align*}
but the following cartesian diagram shows that $\zeta_{\text{v}}^! = \theta_{\text{v}}^!$
\bcd
\mathcal{K}(X|Y) \ar[r] \ar[d] \ar[rd,phantom,"\square"] & \mathcal{L}(X|Y) \ar[r] \ar[d,"\theta"] \ar[rd,phantom,"\square"] & \mathcal{L}(\PP^N|H) \ar[d,"\zeta"] \\
\mathcal{K}(X) \ar[r,"l"] & \mathcal{L}(X) \ar[r] & \mathcal{L}(\PP^N)
\ecd
because $l_{\text{v}}^! [ \mathcal{L}(\PP^N|H)] = \virt{\mathcal{L}(X|Y)}$. Hence, we have
\begin{align*}
k_{\text{v}}^! [ \mathcal{K}(\PP^N|H) ] & = \zeta_{\text{v}}^! \virt{\mathcal{K}}(X) \\
& = \theta_{\text{v}}^! \virt{\mathcal{K}(X)} \\
& = \virt{\mathcal{K}(X|Y)}
\end{align*}
