...
Besides the connections to relative Gromov--Witten theory, we may also apply the recursion formula to study absolute quasimap theory. To be more precise, we obtain a quantum Lefschetz theorem for quasimap invariants, expressing the invariants of a hyperplane section $Y$ in terms of those of $X$. This takes two forms; first, we have a general result which holds without any special restrictions on the target geometry:
