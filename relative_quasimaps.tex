...
The plan of the paper is as follows. In \S \ref{Subsection relative stable quasimaps} we define the space of relative quasimaps, as a substack of the moduli space of (absolute) quasimaps:
