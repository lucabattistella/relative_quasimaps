...
When $g=0$, the moduli space $\Q{0}{n}{\PP^N}{d}$ is smooth and so there exists a natural perfect obstruction theory for the morphism $k$. Thus we have a virtual pull-back map $k^!$ (which also coincides with the diagonal pull-back: see Appendix \ref{appendix:intersection}). We use this to endow $\Q{0}{n}{Y}{\beta}$ with a virtual class:
\begin{equation*} \virt{\Q{0}{n}{Y}{\beta}} := k^! [\Q{0}{n}{H}{d}] \end{equation*}
Thus we can define quasimap invariants for $Y$.
...
\begin{equation*} \mathfrak{Bun}^{G}_{g,n} = \underbrace{\mathfrak{Pic_{g,n}} \times_{\MM_{g,n}} \ldots \times_{\MM_{g,n}} \mathfrak{Pic_{g,n}}}_{r_X} \end{equation*}
...
whereas in the context of this appendix, $Y$ would be expressed as a more parsimonious quotient:
\begin{equation*} Y \cong C(Y) \sslash \Gm \end{equation*}
We saw before that the map $\mathcal{Q}^{\operatorname{GIT}}(\Aaff^4\sslash\Gm^2) \to \mathcal{Q}^{\operatorname{GIT}}(X)$ is not an embedding; however the map $\mathcal{Q}^{\operatorname{GIT}}(C(Y)\sslash\Gm) \to \mathcal{Q}^{\operatorname{GIT}}(X)$ is.
