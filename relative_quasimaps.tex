...
\noindent Under some semipositivity assumptions on $X$ and $Y$, we are able to apply this algorithm to obtain an explicit relation between generating functions (see Theorem \ref{Theorem Quantum Lefschetz} below).
