...
%\textit{Oxford University Press Ltd Journal}
\shorttitle{Quasimap quantum Lefschetz via relative quasimaps}
\author{Luca Battistella\affil{1} and Navid Nabijou\affil{1}}
...
\headabbrevauthor{Battistella, L., and Nabijou, N.}

\address{
\affilnum{1}Department of Mathematics, Imperial College London}

% Address / e-mail address of corresponding author
\correspdetails{navid.nabijou09@imperial.ac.uk}
...
% Enter details of editor communicatin0g this article
\communicated{}
...
\begin{equation*} \big((C, (x_i\in C)_{i=1}^n), (L_\rho,u_\rho)_{\rho \in \Sigma(1)}, (\varphi_m)_{m \in M}\big) \end{equation*}
such that:
\begin{enumerate}
...
\begin{remark} As in the case of relative stable maps (see \S \ref{Subsection relative stable maps}) there is an equivalent definition which is more useful in practice: a quasimap is an $\alpha$-relative quasimap if and only if for every connected component $Z$ of $u_Y^{-1}(0)$ we have that:
\begin{enumerate}
...
These invariants will play a role in our proof of the quasimap quantum Lefschetz formula in \S \ref{Section quasimap mirror theorem}.
