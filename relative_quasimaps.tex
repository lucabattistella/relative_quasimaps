...
\begin{equation*} i^*Y \cdot I_\beta^{X|Y}(z,0) = i^*Y \cdot I_{\beta,\mathrm{FTY}}^{X|Y}(z,0).\end{equation*}
\end{thm}
\begin{proof}
...
\begin{equation*} S^X_{0}(z,\beta) = J^X_\beta(z,0).\end{equation*}
...
& = i^*Y \cdot I_{\beta,\mathrm{FTY}}^{X|Y}(z,0).\end{align*}
But we also have
\begin{equation*} i^* \widetilde{S}_{0,(d)}^{X|Y}(z,\beta) = i^* i_* I_\beta^{X|Y}(z,0) = i^*Y \cdot I_\beta^{X|Y}(z,0)\end{equation*}
and so the result follows.\end{proof}
