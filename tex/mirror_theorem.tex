...
\begin{remark}
Theorem \ref{Theorem Quantum Lefschetz} agrees with the formula obtained in \cite[Theorem~1]{CZ-mirror} when both apply, namely when $X$ is a projective space.
\end{remark}
