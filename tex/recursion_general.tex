...
\bcd
\mathcal{Q}(Y) \ar[r] \ar[d] \ar[rd,phantom,"\square"] & \mathcal{Q}(H) \ar[d,"\theta"] \\
\mathcal{Q}(X) \ar[r] & \mathcal{Q}(\PP^N)
\ecd
we have $\theta^! \virt{\mathcal{Q}(X)} = \virt{\mathcal{Q}(Y)}$; this is carried out in Appendix \ref{Section comparison with GIT construction}.
\end{proof}
...
\[
 \psi^!\virt{\mathcal Q(X)}= \psi^! k^! [ \mathcal{Q}(\PP^N)] = k^!\psi^![\mathcal Q(\PP^N)]
\]
by commutativity of virtual pullbacks. Note that we have:
\begin{equation*} \psi^! \virt{\mathcal{Q}(X)} = \Delta_{X^r}^! \virt{\mathcal{E}(X)} \end{equation*}
...
& =  \theta^!\psi^!\virt{\mathcal Q(X)} & \text{by the splitting axiom} \\
