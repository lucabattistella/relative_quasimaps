...
where the union runs over all splittings $A = (\alpha^{(0)}, \ldots, \alpha^{(r)})$ of the markings, $B = (\beta_0, \ldots, \beta_r)$ of the curve class $\beta$ and all valid multiplicities $M = (m^{(1)}, \ldots, m^{(r)})$ such that the above spaces are non-empty and such that:
\[
Y \cdot \beta_0 +\sum_{i=1}^r m^{(i)}=\sum \alpha^{(0)}
\]
...
On the other hand, $X$ is a GIT quotient  $\Aaff^{\Sigma_X(1)}  \sslash (\CC^*)^r$, and $Y \subseteq X$ defines a $(\CC^*)^r$-invariant subvariety $C(Y)$ of $\Aaff^{\Sigma_X(1)}$, which we call the \ilemph{cone of Y}.
...
We have the following cartesian diagram\marginpar{FIX ME fix the position of the square, also below}
\bcd
...
\bcd
{\displaystyle \coprod_{B : i_* B = B^\prime} \mathcal D^\mathcal{Q}(X|Y,A,B,M)} \ar[r] \ar[d] \ar[rd,phantom,"\square" left] & \mathcal D^\mathcal{Q}(\PP^N|H, A, B^\prime, M) \ar[d] \\
...
\begin{align*}
\mathcal{D}(X|Y) & := \textstyle \coprod_{B : i_* B = B^\prime} \mathcal D^{\mathcal{Q}}(X|Y,A,B,M) &&& \mathcal{D}(\PP^N|H) & := \mathcal D^{\mathcal{Q}}(\PP^N|H,A,B^\prime,M)\\
\mathcal{E}(X|Y) & := \textstyle \coprod_{B : i_* B = B^\prime} \mathcal E^{\mathcal{Q}}(X|Y,A,B,M) &&& \mathcal{E}(\PP^N|H) & := \mathcal E^{\mathcal{Q}}(\PP^N|H,A,B^\prime,M)\\
\mathcal{D}(X) & := \textstyle \coprod_{B : i_* B = B^\prime} \mathcal{D}^{\mathcal{Q}}(X,A,B)  &&& \mathcal{D}(\PP^N) & := \mathcal D^{\mathcal{Q}}(\PP^N,A,B^\prime)\\
\mathcal{E}(X) & := \textstyle \coprod_{B : i_* B = B^\prime} \mathcal{E}^{\mathcal{Q}}(X,A,B) &&& \mathcal{E}(\PP^N) & := \mathcal E^{\mathcal{Q}}(\PP^N,A,B^\prime)\\
