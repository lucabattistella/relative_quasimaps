...
\begin{equation*} \langle \gamma_1 \psi_1^{a_1}, \ldots, \gamma_n \psi_n^{a_n} \rangle_{\Q{0}{\alpha}{X|Y}{\beta}} := \int_{\virt{\Q{0}{\alpha}{X|Y}{\beta}}} \prod_{i=1}^n \ev_i^*(\gamma_i) \cdot \psi_i^{a_i} \end{equation*}
