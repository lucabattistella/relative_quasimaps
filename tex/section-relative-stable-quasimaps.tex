...
\begin{remark} The notation in (2) comes from bivariant intersection theory. Fibrewise, the condition is that the class $f^*[Y] - \sum_i \alpha_i x_i \in A_0(f^{-1}Y)$ is required to be effective.\end{remark}
