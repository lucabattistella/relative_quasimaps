...
Let $Y$ be a very ample hypersurface in $X$.  In \cite{Ga} A. Gathmann constructs a moduli stack of relative stable maps to the pair $(X,Y)$ as a closed substack of the moduli space of (absolute) stable maps to $X$
